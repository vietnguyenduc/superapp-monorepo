...
- **Multi-warehouse:** the hardening migration introduces atomic paired transfers, but the app remains in single-warehouse pilot until a real two-branch acceptance run passes. Keep the limitation banner until then.
