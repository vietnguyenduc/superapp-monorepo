...
vi.mock('../../lib/supabase', async (importOriginal) => {
  ...
  return { ...mod, getCurrentUserId: () => Promise.resolve(MOCK_USER_ID), getCurrentCompanyId: () => Promise.resolve(null), getCurrentInventoryScope: () => Promise.resolve({ companyId: 'company-1', branchId: 'branch-1' }) };
});
