...
export const realInventoryTransactions = [
...
export const getTransactionsByProduct = (productCode) => {
    return realInventoryTransactions.filter(transaction => transaction.productCode === productCode);
};
// Helper function to get stock levels by date
export const getStockLevelsByDate = (date) => {
