...
// Phase 2: Multi-level admin system (same as cashflow)
...
export enum UserRole {
  ADMIN_MASTER = 'admin_master', // Admin toàn hệ thống (có thể quản lý nhiều công ty)
  ADMIN_COMPANY = 'admin_company', // Admin công ty (quản lý 1 công ty)
  WAREHOUSE_ACCOUNTANT = 'warehouse_accountant', // Kế toán kho
  WAREHOUSE_KEEPER = 'warehouse_keeper', // Thủ kho
  STAFF = 'staff', // Nhân viên (thủ kho, kế toán, etc.) - legacy
}
...
export const getRoleDisplayName = (role: UserRole): string => {
  const roleNames: Record<UserRole, string> = {
    [UserRole.ADMIN_MASTER]: 'Admin toàn hệ thống',
    [UserRole.ADMIN_COMPANY]: 'Admin công ty',
