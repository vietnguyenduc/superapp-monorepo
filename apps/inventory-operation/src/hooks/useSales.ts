...
export const useSalesReport = () => {
  ...
  const createSalesRecord = async (data: Omit<SalesRecord, 'id' | 'created_at' | 'updated_at'>) => {
    ...
    try {
      ...
      if (isTrial) {
        console.log('🧪 Trial mode: creating sales record in localStorage');
        // fallbackService handles persistence
        const result = await fallbackService.createSalesRecord(data);
        response = { success: !!result.data, data: result.data, message: result.error };
      } else {
        response = await salesService.createSalesRecord(data);
      }
      ...
      if (response.success && response.data) {
        ...
        setError(response.error || 'Không thể tạo báo cáo bán hàng');
  ...
  const updateSalesRecord = async (id: string, data: Partial<SalesRecord>) => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        setError(response.error || 'Không thể cập nhật báo cáo bán hàng');
        return { success: false, message: response.error };
      }
    } catch (err) {
  ...
  const deleteSalesRecord = async (id: string) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setError(response.error || 'Không thể xóa báo cáo bán hàng');
        return { success: false, message: response.error };
      }
    } catch (err) {
  ...
  const importSalesRecords = async (records: Omit<SalesRecord, 'id' | 'created_at' | 'updated_at'>[]) => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        setError(response.error || 'Không thể import báo cáo bán hàng');
        return { success: false, message: response.error };
      }
    } catch (err) {
  ...
  const loadRecords = async () => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        setError(response.error || 'Không thể tải danh sách xuất đặc biệt');
      }
    } catch (err) {
      setError('Lỗi kết nối khi tải dữ liệu');
  ...
  const createRecord = async (data: Omit<SpecialOutboundRecord, 'id' | 'created_at' | 'updated_at'>) => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        setError(response.error || 'Không thể tạo yêu cầu xuất đặc biệt');
        return { success: false, message: response.error };
      }
    } catch (err) {
  ...
  const updateRecord = async (id: string, data: Partial<SpecialOutboundRecord>) => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        setError(response.error || 'Không thể cập nhật yêu cầu xuất đặc biệt');
        return { success: false, message: response.error };
      }
    } catch (err) {
  ...
  const deleteRecord = async (id: string) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setError(response.error || 'Không thể xóa yêu cầu xuất đặc biệt');
        return { success: false, message: response.error };
      }
    } catch (err) {
  ...
  const approveRecord = async (id: string, comment?: string) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setError(response.error || 'Không thể phê duyệt yêu cầu');
        return { success: false, message: response.error };
      }
    } catch (err) {
  ...
  const rejectRecord = async (id: string, comment: string) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setError(response.error || 'Không thể từ chối yêu cầu');
        return { success: false, message: response.error };
      }
    } catch (err) {
