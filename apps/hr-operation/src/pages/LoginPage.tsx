    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-800">HR & Payroll Operation</h1>
        ...
        <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all shadow-md"
          >
            Đăng nhập
          </button>
        </form>
        ...
        <div className="mt-6 text-center">
          <Link to="/employees" className="text-sm text-indigo-600 hover:text-indigo-700 font-medium">
            ← Quay lại trang chủ
          </Link>
        </div>
      </div>
