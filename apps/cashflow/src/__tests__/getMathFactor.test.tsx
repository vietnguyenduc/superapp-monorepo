  ...
  it("returns correct factors for company 2222 canonical ids", async () => {
    vi.mocked(databaseService.transactionTypes.getTransactionTypes).mockResolvedValue({
      data: [
        ...
        { id: "3efc6ae7-b42f-4dc8-be94-70df75801d9e", name: "Hoàn tiền", color: "green", isActive: true, math_factor: -1, impact_type: "decrease", company_id: "22222222-2222-2222-2222-222222222222" },
        ...
        { id: "refund", name: "Hoàn tiền", color: "green", isActive: true, math_factor: -1, impact_type: "decrease", company_id: null },
