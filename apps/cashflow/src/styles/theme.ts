...
export const appleTheme = {
  ...
  buttons: {
    ...
    secondary: {
      base: "inline-flex items-center justify-center px-4 py-2 border border-gray-400 dark:border-gray-500 text-sm font-semibold rounded-md text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 shadow-sm hover:bg-gray-100 dark:hover:bg-gray-700 hover:shadow-md hover:border-gray-500 dark:hover:border-gray-400 transition-all duration-200 ease-in-out hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100",
      gradient: "",
    },
    success: {
