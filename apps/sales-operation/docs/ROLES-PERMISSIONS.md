...
# sales-operation — Roles & Permissions
...
Mapping defined in `apps/sales-operation/src/types/UserRole.ts`.
Mapping defined in `apps/sales-operation/src/utils/rbac.ts`.
