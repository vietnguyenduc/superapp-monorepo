...
export const UserRoleSwitcher: React.FC = () => {
  const { user, switchRole, permissions } = useAuth();
      ...
      >
        <div className="flex items-center space-x-2">
          ...
          <div className="text-left">
            ...
            <div className="text-xs text-gray-500">{getRoleDisplayName(user.role as UserRole)}</div>
          </div>
        </div>
        <svg
          ...
          <div className="absolute right-0 mt-2 w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-20">
            ...
            <div className="p-3 border-t border-gray-100 bg-gray-50">
              <div className="text-xs text-gray-600">
                <strong>Quyền hiện tại:</strong> {permissions.length} quyền
              </div>
              <div className="text-xs text-gray-500 mt-1">
