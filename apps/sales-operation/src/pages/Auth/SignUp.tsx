...
const SignUp: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (i18n?.changeLanguage && typeof i18n.changeLanguage === 'function' && i18n.language !== language) {
  ...
  const toggleLanguage = () => {
    setLanguage((prev) => {
      ...
      if (i18n?.changeLanguage && typeof i18n.changeLanguage === 'function' && i18n.language !== next) {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <p className="absolute bottom-4 inset-x-0 text-center text-xs text-gray-500 dark:text-gray-400 select-none">
        Quản lý kho Ver 1.0 - 1 sản phẩm trong gói vận hành Doanh nghiệp theo yêu cầu.
      </p>
    </div>
  );
};
