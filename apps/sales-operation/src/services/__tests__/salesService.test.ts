...
describe('SalesService', () => {
  ...
  describe('getSalesRecords', () => {
    ...
    it('applies dateFrom filter', async () => {
      const { gteMock } = mockSupabaseChain({ orderResult: { data: [], error: null } });
    ...
    it('applies dateTo filter', async () => {
      const { lteMock } = mockSupabaseChain({ orderResult: { data: [], error: null } });

      await SalesService.getSalesRecords({ dateTo: '2024-01-31' });

      expect(lteMock).toHaveBeenCalledWith('date', '2024-01-31');
    });
  ...
  describe('createSalesRecord', () => {
    it('creates a sales record successfully', async () => {
      ...
      mockSupabaseChain({ singleResult: { data: { id: 's1', ...record, product: { id: 'p1', name: 'A', business_code: 'SP001' } }, error: null } });
  ...
  describe('updateSalesRecord', () => {
    it('updates a sales record successfully', async () => {
      ...
      mockSupabaseChain({ singleResult: { data: { id: '1', sales_quantity: 150, product: { id: 'p1', name: 'A', business_code: 'SP001' } }, error: null } });
  ...
  describe('getSalesStatistics', () => {
    ...
    it('handles empty data', async () => {
      const { gteMock, lteMock } = mockSupabaseChain({ lteResult: { data: [], error: null } });
